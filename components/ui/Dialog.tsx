  ...
  <DialogPortal>
    <AnimatePresence>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-slate-800 bg-slate-900 p-6 shadow-2xl duration-200 rounded-lg',
          className
        )}
        {...props}
      >
...
const DialogFooter = ({
  ...
  <div
    className={cn('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 pt-4 mt-4 border-t border-slate-800', className)}
    {...props}
  />
);
