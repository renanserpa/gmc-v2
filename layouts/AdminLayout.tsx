...
import { 
    ...
    History, Search, Gavel, CalendarDays
} from 'lucide-react';
...
export default function AdminLayout() {
    const { user, role, signOut, schoolId } = useAuth();
        ...
        <div className="min-h-screen bg-[#020617] flex flex-col md:flex-row text-slate-300">
            <aside className="w-full md:w-80 bg-[#0a0f1d] border-r border-white/5 flex flex-col shrink-0 z-50 shadow-2xl">
                ...
                <nav className="flex-1 p-6 space-y-1 overflow-y-auto custom-scrollbar">
                    <p className="px-6 text-[9px] font-black text-slate-700 uppercase tracking-[0.5em] mb-4 mt-2">Núcleo Central</p>
                    ...
                    <NavLink to="/admin/classes" className={navItemClass}>
                        <CalendarDays size={18} /> Turmas
                    </NavLink>
                    <NavLink to="/admin/users" className={navItemClass}>
                        <Users size={18} /> Alunos & Mestres
                    </NavLink>
